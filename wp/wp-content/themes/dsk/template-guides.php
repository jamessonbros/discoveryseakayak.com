...
<?php if (count($guides)): ?>
  <div class="guides">
    ...
    <!-- <pre><?php print_r($guide) ?></pre> -->
      <div class="row guide">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 <?php echo $i%2 == 1 ? 'col-sm-push-6 col-md-push-6 col-lg-push-6' : '' ?>">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 <?php echo $i%2 == 1 ? 'col-sm-pull-6 col-md-pull-6 col-lg-pull-6' : '' ?>">
